...
object RobotContainer {
  ...
  private val driverController = CommandXboxController(ControllerConstants.kDRIVER_CONTROLLER_PORT)

  /**
   * Use this method to define your `trigger->command` mappings. Triggers can be created via the
   * [Trigger] constructor that takes a [BooleanSupplier][java.util.function.BooleanSupplier] with
   * an arbitrary predicate, or via the named factories in [GenericHID]
   * [edu.wpi.first.wpilibj2.command.button.CommandGenericHID] subclasses such for [Xbox]
